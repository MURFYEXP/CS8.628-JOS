...
//  在这个实验中，自己手写了一个程序lab\kern\entrygdir.c用于进行映射。既然是手写的，
//  所以它的功能就很有限了.4MB物理内存空间
//  把虚拟地址范围：0xf0000000~0xf0400000，映射到物理地址范围：0x00000000~0x00400000上面。
//  把虚拟地址范围：0x00000000~0x00400000，同样映射到物理地址范围：0x00000000~0x00400000上面。
//  任何不在这两个虚拟地址范围内的地址都会引起一个硬件异常。虽然只能映射这两块很小的空间，但是已经足
//  够刚启动程序的时候来使用了
